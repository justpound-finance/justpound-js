...
function _ethJsonRpc(
  ...
  return new Promise<any>((resolve: Function, reject: Function) => {
    const provider = options._JustpoundProvider || _createProvider(options);
...
/**
 * This helps the Justpound.js constructor discover which Ethereum network the
 ...
 * (async function () {
 * 
 *   balance = await Justpound.eth.getBalance(myAddress, provider);
