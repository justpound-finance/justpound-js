/** 
 * Example of redeeming ETH from the Justpound protocol with Justpound.js
 *
...
const Justpound = new Justpound('http://localhost:8545', { privateKey });
...
(async function() {
  ...
  const trx1 = await Justpound.supply(Justpound.ETH, 1);
  console.log('Supply transaction: ', trx1);

  console.log('Redeeming ETH...');
  const trx2 = await Justpound.redeem(Justpound.ETH, 1); // also accepts cToken args
